    ...
    <div className="bg-white rounded-xl shadow-sm overflow-hidden">
      <div className="p-6 border-b border-gray-100">
        <div className="flex items-start justify-between gap-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="font-semibold text-gray-800">Pending Staff Approvals</h3>
              <p className="text-sm text-gray-500 mt-0.5">Approve or reject staff registration requests.</p>
            </div>
          </div>
      ...
      {pending.length === 0 ? (
        <div className="p-10 text-center">
          ...
          <div className="font-medium text-gray-800">No pending approvals</div>
